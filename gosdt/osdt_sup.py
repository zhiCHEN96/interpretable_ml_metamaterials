...
def cart(x, y, name, n, P, N, lamb, w, theta, MAXDEPTH):
    ...
    if name == 'acc':
        ...
        trainout_CART = sklearn.metrics.precision_score(y, pred_CART)
    elif name == 'precision_recall':
        alpha = 0.1
        trainout_CART = alpha * sklearn.metrics.precision_score(y, pred_CART) + (1-alpha) * sklearn.metrics.recall_score(y, pred_CART)
